        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">AfriCities Exhibitors Registration Table</h1>
                                ...
                                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $records = mysqli_query($conn,"select * from exhibitors"); // fetch data from database
                                        ...
                                        <tr>
                                            ...
                                            <td><a target="_blank" href="africities/uploads/exhibitors/<?php echo basename(getcwd().'/africities/uploads/'.basename($data['document'])); ?>"><?php echo basename(getcwd().'/africities/uploads/'.basename($data['document'])); ?></a></td>
