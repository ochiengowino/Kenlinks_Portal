        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">AfriCities Transport Registration Table</h1>
                                ...
                                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $records = mysqli_query($conn,"select * from transport"); // fetch data from database
                                        ...
                                        ?>
                                            ...
                                            <td><?php echo $data['licence_plate']; ?></td>
                                            <td><?php echo $data['id_passport_no']; ?></td>
                                            <td><?php echo $data['category']; ?></td>
                                            <td><a target="_blank" href="africities/uploads/transport/insurance_certificate/<?php echo basename(getcwd().'/africities/uploads/'.basename($data['motor_vehicle_insurance'])); ?>"><?php echo basename(getcwd().'/africities/uploads/'.basename($data['motor_vehicle_insurance'])); ?></a></td>
                                            <td><a target="_blank" href="africities/uploads/transport/drivers_licence/<?php echo basename(getcwd().'/africities/uploads/'.basename($data['drivers_licence'])); ?>"><?php echo basename(getcwd().'/africities/uploads/'.basename($data['drivers_licence'])); ?></a></td>
                                            <td><a target="_blank" href="africities/uploads/transport/id_passport/<?php echo basename(getcwd().'/africities/uploads/'.basename($data['id_passport_copy'])); ?>"><?php echo basename(getcwd().'/africities/uploads/'.basename($data['id_passport_copy'])); ?></a></td>
