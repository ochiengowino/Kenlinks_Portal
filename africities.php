...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="exhibitors.php">
                    <!-- <i class="fas fa-fw fa-tachometer-alt"></i> -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">AfriCities Hotels Registration Table</h1>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                            include "africities/php/db_conn.php"; 
                                            
                                            $records = mysqli_query($conn,"select * from hotels"); // fetch data from database
                                        ...
                                        <tr>
                                            <?php
                                            // echo basename($data['business_permit']);
                                            // echo basename(getcwd().'/africities/uploads/'.basename($data['business_permit']));
                                        ?>
                                            ...
                                            <td><?php echo $data['town_city']; ?></td>
                                            <td><?php echo $data['distance_venue']; ?></td>
                                            <!-- <img class="document-img" src="africities/img/download.png"> -->
                                            <td><a target="_blank" href="africities/uploads/hotels/business_permit/<?php echo basename(getcwd().'/africities/uploads/'.basename($data['business_permit'])); ?>"><?php echo basename(getcwd().'/africities/uploads/'.basename($data['business_permit'])); ?></a></td>
                                            <td><a target="_blank" href="africities/uploads/hotels/registration_certificate/<?php echo basename(getcwd().'/africities/uploads/'.basename($data['registration_certificate'])); ?>"><?php echo basename(getcwd().'/africities/uploads/'.basename($data['registration_certificate'])); ?></a></td>
                                            <td><a target="_blank" href="africities/uploads/hotels/hotel_keepers_certificate/<?php echo basename(getcwd().'/africities/uploads/'.basename($data['hotel_keepers_certificate'])); ?>"><?php echo basename(getcwd().'/africities/uploads/'.basename($data['hotel_keepers_certificate'])); ?></a></td>
                                            <td><a target="_blank" href="africities/uploads/hotels/id_passport_copy/<?php echo basename(getcwd().'/africities/uploads/'.basename($data['id_passport_copy'])); ?>"><?php echo basename(getcwd().'/africities/uploads/'.basename($data['id_passport_copy'])); ?></a></td>                                
